...
public class Animate {
	...
	public void animate(AnimatableObject ani, int endingX, int endingY, int endingWidth, int endingHeight, int operationLength, int stepNum) throws InterruptedException {
